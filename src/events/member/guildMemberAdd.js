...
module.exports = {
    ...
    async execute(member, client) {
        ...
        canvas.context.fillText(`You are the ${member.guild.memberCount}th member.s`, 512, 475);
        ...
        const attachment = new AttachmentBuilder(await canvas.create.encode("png"), { name: "profile-image.png" });
